...
function sortNums(nums, direction) {
    if (direction === 'ascending') {
        ...
        console.error('Not correct input!');
    }
}
...
let mapedArr = coursesAndDurationArray.map(function (value, index) {
...
// - знайти піковий туз
let findSpadeAce = cardsDeck.find(value => value.cardSuit === 'spade' && value.value === 'ace');
console.log(findSpadeAce);
// for (const item of cardsDeck) {
...
// - всі шістки
let filterSixs = cardsDeck.filter(value => value.value === '6');
console.log(filterSixs);
// - всі червоні карти
let filterReds = cardsDeck.filter(value => value.color === 'red');
...
let filteredDocker = coursesArray.filter(value => value.modules.includes('docker'));
// let filteredDocker = coursesArray.filter(value => {
